...
class _FilterScreenState extends State<FilterScreen> {
  List strings = [
      "3 bedroom",'2 Bedroom', "Selfcon", "Another house", "another another House"
  ];
  List cash = [
      "50,000 - 100,000","100,000 - 180,000", "180,000-200,000", "200,000-280,000", "280,000 - 380,000","380,000 - 450,000"
  ];
  @override
               ...
               Expanded(
                 child: Column(
                   ...
                   children:  [
                    ...
                    const CustomDropDown(),
                     Text("Pick Your Home Type",  style: GoogleFonts.poppins(
                        textStyle: Theme.of(context).textTheme.bodyText1!.copyWith(fontWeight: FontWeight.w500,fontSize: 20, color: const Color(0xff363B64)))),
                        WrappingWidget(strings: strings),
                        Padding(
                 padding: const EdgeInsets.only(top:15.0),
                 child: Text("Pick Price Range",  style: GoogleFonts.poppins(
                 textStyle: Theme.of(context).textTheme.bodyText1!.copyWith(fontWeight: FontWeight.w500,fontSize: 20, color: const Color(0xff363B64)))),
                        ),
                ...
                Padding(
                  ...
                  child: ElevatedButton(onPressed: (){
                         ...
                         ), style: ElevatedButton.styleFrom(fixedSize: Size(deviceSize.width, 50),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Wrap(
        ...
        children: strings.map((item) => Padding(
